...
// ускорение или замедление идёт линейно или по синусоиде.
define ("STL_MOVE_LINEARY", 0);// ускорение/замедление - линейно
define ("STL_MOVE_FAST", 1);// ускорение/замедление - быстро
define ("STL_MOVE_SLOW", 2);// ускорение/замедление - медленно




class servo_modelBlank // чистая модель поведенья
{
